...
export function makeFlower({
  ...
  // came off and read as being spat out of the middle of the bloom, born inside
  // the flower rather than falling off it. World quaternion and scale come with
  // it now, so the first frame after release is pixel-identical to the last
  // frame before it and the fall starts from where the petal actually was.
  //
