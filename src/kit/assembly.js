...
// first and read as exactly what it was: a triangle with a tiny circle head. The obi pinch, the collar step and the hat brim are all
...
export function makeAssembly({ count = 8, radius = 3.0, center = [0, 0], facing = [0, 0], spread = 1.4, color = INK_LIT, seed = 6 } = {}) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // off ink — the seated crowds stayed noticeably darker than every other
    // figure. Around 1.0 it does what it was always meant
