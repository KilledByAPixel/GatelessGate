...
// under the tree, on the ground, stands the one who came to ask: hands in his
// sleeves, looking up at a man who cannot open his mouth.
...
const CAM = { distance: 10.5, target: [-3.8, 2.3, -1.6], heading: -48, pitch: -6.5, minPitch: -9.9 };
 ...
 const cliff2 = makeCliff({
  ...
  // hanging out. Three lobes in the oak's own canopy grammar —
  ...
  // man hanging from his jaw — biting into the branch, tilted back, dangling.
  ...
  // at the sides and back, which read as a cut rather than as ground.
