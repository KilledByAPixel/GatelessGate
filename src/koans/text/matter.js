...
export default {
  ...
  "afterword": {
    ...
    "text": {
      ...
      "colophon": "Five days before the end of the summer retreat, the year the era changed to Jotei. Respectfully set down by the monk Ekai, called Mumon, eighth in descent from Yogi.",
