...
// looks past, off to the side of the frame, facing
...
// HIS TREE IS HIS OWN, set up and placed by this page. It used to be picked
// out of the hub's
...
export default {
  ...
  build() {
    ...
    // WILDFLOWERS through the valley. The stage is cleared of people and
