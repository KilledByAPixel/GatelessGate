...
// fresh shader link — and it cannot drop whatever else the case authored on
// that material (flatShading, side, opacity...) the way a hand-built
// replacement can if it forgets to repeat one.
//
// The old reason was sharper: the debug workbench cached a plain-Lambert
