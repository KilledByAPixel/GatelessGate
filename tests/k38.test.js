...
test('case 38: a tug turns him all the way round, and back to where he stood', () => {
...
test('case 38: he turns CLOCKWISE, both halves the same way round', () => {
...
test('case 38: nothing the reader can see ever jumps', () => {
...
test('case 38: he shakes the tail when he gets there, not when you tug it', () => {
...
test('case 38: a tug is refused until he has finished the circle', () => {
...
test('case 38: nothing goes non-finite over a long run of tugging', () => {
...
test('case 38: the whole animal is the target, not just his tail', () => {
